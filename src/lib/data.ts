...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://rafs-souq.com";
...
export const COLLECTIONS: Collection[] = [
  ...
  },
  {
    ...
    description: "Finishing touches designed to elevate everyday and occasion looks.",
    image: "/brand/rafs-souq-logo.png",
    itemCount: 0,
  ...
  },
  {
    id: "c-006",
    name: "Kids Turbans",
    description: "Comfortable, easy-to-wear turbans made especially for little ones.",
    image: "/brand/rafs-souq-logo.png",
    itemCount: 0,
    category: "kids-turbans",
  },
  {
    id: "c-007",
    name: "Headbands",
    description: "Versatile headbands that bring effortless polish to every outfit.",
    image: "/brand/rafs-souq-logo.png",
    itemCount: 0,
    category: "headbands",
  },
